...
jest.mock('@/database/usePrintLogDatabase', () => ({ usePrintLogDatabase: jest.fn() }));
jest.mock('@/services/deviceId', () => ({ getOrCreateDeviceId: jest.fn() }));
jest.mock('@/services/planCache', () => ({ getCachedPlan: jest.fn() }));
