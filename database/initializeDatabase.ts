...
async function seedProdutosPadrao(database: SQLiteDatabase) {
  const produtos = [
    ...
    { id: 14, nome: "Artesanal Bacon", tipoProdutoId: 2, preco: 28, origemProdutoId: null, ingredientes: "Hambúrguer artesanal 150g, Cheddar, Bacon, Cebola caramelizada, Alface, Tomate, Molho de alho." },
    { id: 15, nome: "Artesanal Basic", tipoProdutoId: 2, preco: 23, origemProdutoId: null, ingredientes: "Hambúrguer artesanal 150g, Bacon, Queijo, Cebola caramelizada, Molho de alho." },
    { id: 16, nome: "Artesanal 300 Duplo", tipoProdutoId: 2, preco: 35, origemProdutoId: null, ingredientes: "2 Hambúrgueres artesanais 150g, Bacon, Queijo, Cebola caramelizada, Molho de alho." },
    { id: 17, nome: "Artesanal Burger", tipoProdutoId: 2, preco: 25, origemProdutoId: null, ingredientes: "Hambúrguer artesanal 150g, Bacon, Queijo, Alface, Tomate, Mostarda com mel." },
    { id: 18, nome: "Artesanal Colombiano", tipoProdutoId: 2, preco: 28, origemProdutoId: null, ingredientes: "Hambúrguer artesanal 150g, Bacon, Queijo, Alface, Tomate, Batata palha, Ovo, Mostarda com mel." },
    { id: 19, nome: "Artesanal Basic Salada", tipoProdutoId: 2, preco: 25, origemProdutoId: null, ingredientes: "Hambúrguer artesanal 150g, Queijo, Alface, Tomate, Cebola caramelizada." },
    { id: 20, nome: "Artesanal Picante", tipoProdutoId: 2, preco: 28, origemProdutoId: null, ingredientes: "Hambúrguer artesanal 150g, Queijo, Bacon, Alface, Tomate, Molho de alho, Ovo, Pimenta." },
    { id: 21, nome: "Artesanal Catupiry", tipoProdutoId: 2, preco: 28, origemProdutoId: null, ingredientes: "Hambúrguer artesanal 150g, Bacon, Rúcula, Catupiry, Molho de alho." },
    { id: 22, nome: "Artesanal Barbecue", tipoProdutoId: 2, preco: 30, origemProdutoId: null, ingredientes: "Hambúrguer artesanal 150g, Bacon, Queijo, Onion rings, Molho barbecue." },
    { id: 23, nome: "Artesanal Dú Chef", tipoProdutoId: 2, preco: 37, origemProdutoId: null, ingredientes: "2 Hambúrgueres artesanais 150g, Bacon, Cheddar, Cebola caramelizada, Rúcula, Creme de alho." },
